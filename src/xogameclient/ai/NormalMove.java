...
public class NormalMove {
     ...
     public static BestMove.Move normalMove(char[][] board,char c){
         
         // Check Winning 
        BestMove.Move temp = checkWinning(board, c);
        char t;
         if(c == 'X') t='O';
           else t = 'X';
    ...
    private static BestMove.Move checkWinning(char[][] board,char c){
        BestMove.Move temp = new BestMove.Move();
